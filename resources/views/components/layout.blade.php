    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-4 font-medium">
                ...
                <li>
                    <x-link href="/users" :active="request()->is('users') || request()->is('users/*')" title="Users"
                        :typeoflink="'nav-link'">
                        <x-slot:icon>
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                ...
                <li>
                    <x-link href="/events" :active="request()->is('events') || request()->is('events/*')" title="Events"
                        :typeoflink="'nav-link'">
                        <x-slot:icon>
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                ...
                <li>
                    <x-link href="/departments" :active="request()->is('departments') || request()->is('departments/*')"
                        title="Departments" :typeoflink="'nav-link'">
                        <x-slot:icon>
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 24 24">
                ...
                <li>
                    <x-link href="/tickets" :active="request()->is('tickets') || request()->is('tickets/*')"
                        title="Tickets" :typeoflink="'nav-link'">
                        <x-slot:icon>
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 24 24">
